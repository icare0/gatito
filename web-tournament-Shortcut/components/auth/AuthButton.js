...
export default function AuthButton() {
        ...
        {dropdownOpen && (
          ...
          >
            <div className="px-4 py-2 border-b border-gray-200">
              <p className="text-sm font-medium text-gray-900">{session.user.name || session.user.dbUser?.pseudo}</p>
            ...
            {session.user.isAdmin && (
              <Link href="/admin" className="block px-4 py-2 text-sm text-[#009898] hover:bg-gray-100">
                {t('admin_panel')}
              </Link>
            )}
  ...
  return (
    <button
      ...
      className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#009898] hover:bg-[#006C4C] focus:outline-none"
    >
